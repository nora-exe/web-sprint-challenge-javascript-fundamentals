...
// Closures let a child-level scope (nestedFunction()) access things from a parent level scope (internal, external). Things can be passed down to childs, but not back up to parent.
...
console.log(animalNames());
  ...
  */
  ...
  function USApop(){
    ...
    return zooAnimals.reduce((accumulator, item) => {
